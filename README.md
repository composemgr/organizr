...
HTPC/Homelab services organizer with authentication
...
```bash
curl -q -LSsf "https://raw.githubusercontent.com/composemgr/organizr/main/docker-compose.yaml" -o compose.yml
```
